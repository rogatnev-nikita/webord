...
?>
    ...
    <head>
        ...
        <title>РАЗРАБОТКА ИНТЕРНЕТ-МАГАЗИНОВ | «WEBORD» Digital Agency</title>
    ...
    <body>
              ...
              <span class="hamburger__box">
                ...
                <nav class="header__navigation header__navigation--closed">
                    <ul>
                        ...
                        <li><a href="../shop/" class="active">Интернет-магазины</a></li>
        ...
        <!-- PROMO -->
        <section class="promo promo--shop">
            <div class="promo__container">
                ...
                <div class="promo__text">
                    <h1>РАЗРАБОТКА ИНТЕРНЕТ-МАГАЗИНОВ - больших сайтов для больших продаж</h1>
        ...
        <section class="service-about">
            <div class="service-about__container">
                ...
                <img src="../img/service-about/service-about__shop.svg">
            </div>
        </section>
        <!-- SERVICE ABOUT -->
        ...
        <section class="service-more">
            <div class="service-more__container">
                ...
                <p>Создание интернет-магазина — это возможность выхода на принципиально иной рынок, нежели может предложить любое размещение в реальном мире. Интернет-магазин — это не ещё одна точка продаж, а зачастую самое эффективное средство контакта
                    с клиентами. Если у вас есть уникальный товар или вы готовы сделать выгодное предложение — интернет-магазин поможет дать информацию об этом всем интересующимся.</p>
