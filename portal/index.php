...
?>
    ...
    <head>
        ...
        <title>РАЗРАБОТКА ПОРТАЛОВ | «WEBORD» Digital Agency</title>
    ...
    <body>
              ...
              <span class="hamburger__box">
                ...
                <nav class="header__navigation header__navigation--closed">
                    <ul>
                        ...
                        <li><a href="../portal/" class="active">Порталы</a></li>
                    </ul>
                </nav>
            </div>
        </header>
        ...
        <!-- PROMO -->
        <section class="promo promo--portal">
            <div class="promo__container">
                ...
                <div class="promo__text">
                    <h1>РАЗРАБОТКА ПОРТАЛОВ - громадных сайтов для множества людей</h1>
        ...
        <section class="service-about">
            <div class="service-about__container">
                ...
                <img src="../img/service-about/service-about__portal.svg">
            </div>
        </section>
        <!-- SERVICE ABOUT -->
        ...
        <section class="service-more">
            <div class="service-more__container">
                ...
                <p>Цель создания Интернет-портала — привлечение и удержание максимально возможного числа пользователей. Каждый посетитель Интернет-портала должен найти его самым исчерпывающим, самым полным, удобным в поиске необходимых знаний, популярным
                    и ценным источником самой разной тематической и иной информации, удобным местом общения, площадкой для собственных публикаций.</p>
