...
?>
    ...
    <body>
            ...
            <div class="header__container">
              ...
              <span class="hamburger__box">
                ...
                <nav class="header__navigation header__navigation--closed">
                    <ul>
                        <li><a href="../landing/" class="active">Лендинги</a></li>
        ...
        <!-- PROMO -->
        <section class="promo promo--landing">
            <div class="promo__container">
                ...
                <div class="promo__text">
                    <h1>РАЗРАБОТКА ПОСАДОЧНЫХ СТРАНИЦ - маленьких сайтов для больших продаж</h1>
        ...
        <section class="service-about">
            <div class="service-about__container">
                ...
                <p>Продающая страница (landing page) — действенный современный инструмент для повышения продаж в бизнесе. Попав на лендинг с рекламного объявления, пользователь увидит именно то, что искал. Ниже приводится ориентировочная схема продающей
                    страницы:
                </p>
                <img src="../img/service-about/service-about__landing.svg">
            </div>
        </section>
        <!-- SERVICE ABOUT -->
