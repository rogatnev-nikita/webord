...
?>
    ...
    <head>
        ...
        <title>РАЗРАБОТКА САЙТОВ-ВИЗИТОК | «WEBORD» Digital Agency</title>
    ...
    <body>
              ...
              <span class="hamburger__box">
                ...
                <nav class="header__navigation header__navigation--closed">
                    <ul>
                        ...
                        <li><a href="../vizitka/" class="active">Сайты-визитки</a></li>
        ...
        <!-- PROMO -->
        <section class="promo promo--vizitka">
            <div class="promo__container">
                ...
                <div class="promo__text">
                    <h1>РАЗРАБОТКА САЙТОВ-ВИЗИТОК - маленьких сайтов для больших людей</h1>
        ...
        <section class="service-about">
            <div class="service-about__container">
                <h2>Сайты-визитки</h2>
                <p>Сайт визитка – это небольшой информационный сайт о компании, на котором Вы можете рассказать клиентам о ваших ценах, услугах, товарах, акциях и многом другом. При желании на сайте можно разместить каталог продукции, схему проезда, отзывы
                    клиентов, новости компании, карту сайта, форму быстрой связи или форму предварительного заказа.</p>
                <img src="../img/service-about/service-about__vizitka.svg">
            </div>
        </section>
        <!-- SERVICE ABOUT -->
