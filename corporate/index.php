...
?>
    ...
    <head>
        ...
        <title>РАЗРАБОТКА КОРПОРАТИВНЫХ САЙТОВ | «WEBORD» Digital Agency</title>
    ...
    <body>
              ...
              <span class="hamburger__box">
                ...
                <nav class="header__navigation header__navigation--closed">
                    <ul>
                        ...
                        <li><a href="../corporate/" class="active">Корпоративные</a></li>
        ...
        <!-- PROMO -->
        <section class="promo promo--corporate">
            <div class="promo__container">
                ...
                <div class="promo__text">
                    <h1>РАЗРАБОТКА КОРПОРАТИВНЫХ САЙТОВ - информативных сайтов для больших команд</h1>
        ...
        <section class="service-about">
            <div class="service-about__container">
                ...
                <img src="../img/service-about/service-about__corporate.svg">
            </div>
        </section>
        <!-- SERVICE ABOUT -->
        ...
        <section class="service-more">
            <div class="service-more__container">
                ...
                <p>Нам известны десятки случаев, когда менеджер на стороне заказчика шел на повышение сразу после запуска нового сайта. Если вы сейчас в поиске разработчика — значит, вскоре вам предстоит увлекательный, захватывающий процесс. И успех в этом
                    деле крайне важен. Для вашей компании это дополнительные продажи и узнаваемость на рынке. А чего ждете от разработки сайта лично вы?</p>
